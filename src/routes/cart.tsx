    ...
    <PageShell className="space-y-8">
      ...
      <div className="flex max-w-md flex-col gap-2 sm:flex-row sm:items-center">
        ...
        <input
          ...
          className="h-9 flex-1 rounded-lg border-2 border-input bg-card px-3 text-sm shadow-xs outline-none transition-colors focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50"
        />
        <Button
          type="button"
          variant="secondary"
